...
public class GemistryBlockTagsProvider extends BlockTagsProvider {
    ...
    private void addHarvestLevelTags() {
        tag(BlockTags.MINEABLE_WITH_PICKAXE).add(GemistryBlocks.RUBY_ORE.get()).add(GemistryBlocks.DEEPSLATE_RUBY_ORE.get()).add(GemistryBlocks.RUBY_BLOCK.get());
        tag(BlockTags.NEEDS_IRON_TOOL).add(GemistryBlocks.RUBY_ORE.get()).add(GemistryBlocks.DEEPSLATE_RUBY_ORE.get()).add(GemistryBlocks.RUBY_BLOCK.get());
    }
    ...
    private void addNeoForgeConventionTags() {
        ...
        tag(Tags.Blocks.ORES).addTag(commonTag("ores/ruby"));
        tag(Tags.Blocks.ORES_IN_GROUND_STONE).add(GemistryBlocks.RUBY_ORE.get());
        tag(Tags.Blocks.ORES_IN_GROUND_DEEPSLATE).add(GemistryBlocks.DEEPSLATE_RUBY_ORE.get());
        tag(Tags.Blocks.STORAGE_BLOCKS).addTag(commonTag("storage_blocks/ruby"));

        tag(Tags.Blocks.ORE_RATES_SINGULAR).add(GemistryBlocks.RUBY_ORE.get()).add(GemistryBlocks.DEEPSLATE_RUBY_ORE.get());
    }
    ...
    private void addVanillaTags() {
        tag(BlockTags.BEACON_BASE_BLOCKS).add(GemistryBlocks.RUBY_BLOCK.get());
    }
