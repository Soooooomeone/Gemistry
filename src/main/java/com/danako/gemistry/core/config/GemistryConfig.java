...
public class GemistryConfig {
    ...
    static {
        ...
        BUILDER.comment("Toggle whether a given ore generates in the world at all.", "Setting this to false stops NEW chunks from generating the ore.", "Chunks that were already generated before you changed this will keep whatever ore they already have.").push("ore_generation");

        GENERATE_RUBY_ORE = BUILDER.comment("Whether Ruby Ore should generate in the world").define("generateRubyOre", true);
        GENERATE_SAPPHIRE_ORE = BUILDER.comment("Whether Sapphire Ore should generate in the world").define("generateSapphireOre", true);
        GENERATE_AQUAMARINE_ORE = BUILDER.comment("Whether Aquamarine Ore should generate in the world").define("generateAquamarineOre", true);
        GENERATE_AMBER_ORE = BUILDER.comment("Whether Amber Ore should generate in the world").define("generateAmberOre", true);
        GENERATE_ONYX_ORE = BUILDER.comment("Whether Onyx Ore should generate in the world").define("generateOnyxOre", true);
