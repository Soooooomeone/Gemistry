...
public final class GemistryTags {
    ...
    public static final TagKey<Enchantment> ATTUNEMENT_COMMON = TagKey.create(Registries.ENCHANTMENT, Identifier.fromNamespaceAndPath(Gemistry.MODID, "attunement/common"));
