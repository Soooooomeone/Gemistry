...
public class GemistryBlockTagsProvider extends BlockTagsProvider {
    ...
    private void addNeoForgeConventionTags() {
        ...
        tag(Tags.Blocks.ORES).addTag(commonTag("ores/ruby")).addTag(commonTag("ores/sapphire")).addTag(commonTag("ores/aquamarine"));
        tag(Tags.Blocks.ORES_IN_GROUND_STONE).add(GemistryBlocks.RUBY_ORE.get()).add(GemistryBlocks.SAPPHIRE_ORE.get()).add(GemistryBlocks.AQUAMARINE_ORE.get());
        tag(Tags.Blocks.ORES_IN_GROUND_DEEPSLATE).add(GemistryBlocks.DEEPSLATE_RUBY_ORE.get()).add(GemistryBlocks.DEEPSLATE_SAPPHIRE_ORE.get()).add(GemistryBlocks.DEEPSLATE_AQUAMARINE_ORE.get());
        tag(Tags.Blocks.STORAGE_BLOCKS).addTag(commonTag("storage_blocks/ruby")).addTag(commonTag("storage_blocks/sapphire")).addTag(commonTag("storage_blocks/aquamarine"));

        tag(Tags.Blocks.ORE_RATES_SINGULAR).add(GemistryBlocks.RUBY_ORE.get()).add(GemistryBlocks.DEEPSLATE_RUBY_ORE.get()).add(GemistryBlocks.SAPPHIRE_ORE.get()).add(GemistryBlocks.DEEPSLATE_SAPPHIRE_ORE.get()).add(GemistryBlocks.AQUAMARINE_ORE.get()).add(GemistryBlocks.DEEPSLATE_AQUAMARINE_ORE.get());
    }
    ...
    private void addVanillaTags() {
        tag(BlockTags.BEACON_BASE_BLOCKS).add(GemistryBlocks.RUBY_BLOCK.get()).add(GemistryBlocks.SAPPHIRE_BLOCK.get()).add(GemistryBlocks.AQUAMARINE_BLOCK.get());
    }
