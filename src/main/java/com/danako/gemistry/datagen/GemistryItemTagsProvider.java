...
public class GemistryItemTagsProvider extends ItemTagsProvider {
    ...
    private void addEnchantableTags() {
        ...
        tag(ItemTags.FIRE_ASPECT_ENCHANTABLE).add(GemistryItems.RUBY_SWORD.get()).add(GemistryItems.RUBY_SPEAR.get()).add(GemistryItems.SAPPHIRE_SWORD.get()).add(GemistryItems.SAPPHIRE_SPEAR.get());

        tag(ItemTags.MINING_ENCHANTABLE).add(GemistryItems.RUBY_PICKAXE.get()).add(GemistryItems.RUBY_AXE.get()).add(GemistryItems.RUBY_SHOVEL.get()).add(GemistryItems.RUBY_HOE.get()).add(GemistryItems.SAPPHIRE_PICKAXE.get()).add(GemistryItems.SAPPHIRE_AXE.get()).add(GemistryItems.SAPPHIRE_SHOVEL.get()).add(GemistryItems.SAPPHIRE_HOE.get());
        ...
        tag(ItemTags.SWEEPING_ENCHANTABLE).add(GemistryItems.RUBY_SWORD.get()).add(GemistryItems.SAPPHIRE_SWORD.get());
        tag(ItemTags.LUNGE_ENCHANTABLE).add(GemistryItems.RUBY_SPEAR.get()).add(GemistryItems.SAPPHIRE_SPEAR.get());

        tag(ItemTags.MELEE_WEAPON_ENCHANTABLE).add(GemistryItems.RUBY_SWORD.get()).add(GemistryItems.RUBY_SPEAR.get()).add(GemistryItems.SAPPHIRE_SWORD.get()).add(GemistryItems.SAPPHIRE_SPEAR.get());

        tag(ItemTags.SHARP_WEAPON_ENCHANTABLE).add(GemistryItems.RUBY_SWORD.get()).add(GemistryItems.RUBY_AXE.get()).add(GemistryItems.SAPPHIRE_SWORD.get()).add(GemistryItems.SAPPHIRE_AXE.get());

        tag(ItemTags.WEAPON_ENCHANTABLE).add(GemistryItems.RUBY_SWORD.get()).add(GemistryItems.RUBY_SPEAR.get()).add(GemistryItems.SAPPHIRE_SWORD.get()).add(GemistryItems.SAPPHIRE_SPEAR.get());

        tag(ItemTags.ARMOR_ENCHANTABLE).add(GemistryItems.RUBY_HELMET.get()).add(GemistryItems.RUBY_CHESTPLATE.get()).add(GemistryItems.RUBY_LEGGINGS.get()).add(GemistryItems.RUBY_BOOTS.get()).add(GemistryItems.RUBY_HORSE_ARMOR.get()).add(GemistryItems.RUBY_NAUTILUS_ARMOR.get()).add(GemistryItems.SAPPHIRE_HELMET.get()).add(GemistryItems.SAPPHIRE_CHESTPLATE.get()).add(GemistryItems.SAPPHIRE_LEGGINGS.get()).add(GemistryItems.SAPPHIRE_BOOTS.get()).add(GemistryItems.SAPPHIRE_HORSE_ARMOR.get()).add(GemistryItems.SAPPHIRE_NAUTILUS_ARMOR.get());

        tag(ItemTags.HEAD_ARMOR_ENCHANTABLE).add(GemistryItems.RUBY_HELMET.get()).add(GemistryItems.SAPPHIRE_HELMET.get());
        tag(ItemTags.CHEST_ARMOR_ENCHANTABLE).add(GemistryItems.RUBY_CHESTPLATE.get()).add(GemistryItems.SAPPHIRE_CHESTPLATE.get());
        tag(ItemTags.LEG_ARMOR_ENCHANTABLE).add(GemistryItems.RUBY_LEGGINGS.get()).add(GemistryItems.SAPPHIRE_LEGGINGS.get());
        tag(ItemTags.FOOT_ARMOR_ENCHANTABLE).add(GemistryItems.RUBY_BOOTS.get()).add(GemistryItems.SAPPHIRE_BOOTS.get());
    ...
    private void addVanillaTags() {
        tag(ItemTags.SWORDS).add(GemistryItems.RUBY_SWORD.get()).add(GemistryItems.SAPPHIRE_SWORD.get());
        tag(ItemTags.AXES).add(GemistryItems.RUBY_AXE.get()).add(GemistryItems.SAPPHIRE_AXE.get());
        tag(ItemTags.PICKAXES).add(GemistryItems.RUBY_PICKAXE.get()).add(GemistryItems.SAPPHIRE_PICKAXE.get());
        tag(ItemTags.SHOVELS).add(GemistryItems.RUBY_SHOVEL.get()).add(GemistryItems.SAPPHIRE_SHOVEL.get());
        tag(ItemTags.HOES).add(GemistryItems.RUBY_HOE.get()).add(GemistryItems.SAPPHIRE_HOE.get());
        tag(ItemTags.SPEARS).add(GemistryItems.RUBY_SPEAR.get()).add(GemistryItems.SAPPHIRE_SPEAR.get());
        tag(ItemTags.BEACON_PAYMENT_ITEMS).add(GemistryItems.RUBY.get()).add(GemistryItems.SAPPHIRE.get());
    }
    ...
    private void addNeoForgeConventionTags() {
        ...
        tag(commonTag("tools/mining_tool")).add(GemistryItems.RUBY_PICKAXE.get()).add(GemistryItems.SAPPHIRE_PICKAXE.get());
        tag(commonTag("tools/melee_weapon")).add(GemistryItems.RUBY_SWORD.get()).add(GemistryItems.RUBY_AXE.get()).add(GemistryItems.RUBY_SPEAR.get()).add(GemistryItems.SAPPHIRE_SWORD.get()).add(GemistryItems.SAPPHIRE_AXE.get()).add(GemistryItems.SAPPHIRE_SPEAR.get());
        ...
        tag(Tags.Items.ARMORS_HORSE).add(GemistryItems.RUBY_HORSE_ARMOR.get()).add(GemistryItems.SAPPHIRE_HORSE_ARMOR.get());
        tag(Tags.Items.ARMORS_NAUTILUS).add(GemistryItems.RUBY_NAUTILUS_ARMOR.get()).add(GemistryItems.SAPPHIRE_NAUTILUS_ARMOR.get());
    }
